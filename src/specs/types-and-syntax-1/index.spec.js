describe('unit testing - types and syntax - 1', () => {
    ...
    test('array manipulations', () => {
        ...
        let cars = ["Saab", "Volvo", "BMW"];    //Porsche, Saab, Volvo, BMW, Audi
                                                //Porsche, Ferrari, Volvo, BMW, Audi
        cars.push("Audi");
    ...
    test('working with maps', () => {
        ...
        expect(myMap.get("a")).toEqual(1);
        expect(myMap.get("b")).toEqual(2);
        expect(myMap.get("c")).toEqual(3);
